...
const TimelineItem = ({
  ...
  return (
    <div id={id} className="relative mb-8 md:mb-16">
      {/* Mobile Layout */}
      <div className="md:hidden">
        <div className="flex items-start gap-4 mb-4">
          <div className="flex-shrink-0">
            <div
              className="text-sm font-bold text-white px-3 py-2 rounded-lg shadow-sm text-center min-w-[80px]"
              style={{ backgroundColor: "#76424E" }}
            >
              {time}
            </div>
            <div className="text-xs text-gray-600 mt-1 text-center">{duration}</div>
          </div>

          <div className="flex-shrink-0 relative mt-3">
            <div
              className="w-4 h-4 rounded-full border-2 border-white shadow-lg z-10 relative"
            ...
            <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
              <div className="p-4">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-lg font-bold text-gray-900 leading-tight pr-2">{title}</h3>
                  <button
                    onClick={() => setIsExpanded(!isExpanded)}
                    className="flex-shrink-0 p-1 text-gray-600 hover:text-gray-900 transition-colors rounded"
                  >
                ...
                {isExpanded && (
                  <div className="border-t border-gray-100 pt-4 animate-in slide-in-from-top-2 duration-300">
                    {children}
                  </div>
                )}
              </div>
...
const SpeakerCard = ({
  ...
  <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 md:p-8 mb-4 md:mb-6 border border-gray-200 hover:border-yellow-300 transition-all duration-300 hover:shadow-md">
    <div className="flex flex-col sm:flex-row items-start gap-4 md:gap-6 mb-4 md:mb-6">
      <img
        src={image || "/placeholder.svg"}
        alt={name}
        className="w-16 h-16 md:w-20 md:h-20 rounded-full object-cover border-4 border-white shadow-lg mx-auto sm:mx-0"
      />
      <div className="flex-1 text-center sm:text-right">
        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-1 md:mb-2">{name}</h4>
        <p className="text-sm md:text-base text-gray-600 mb-2 md:mb-3">{title}</p>
        <h5 className="text-base md:text-lg font-semibold text-gray-800 leading-relaxed">{research}</h5>
      </div>
    </div>

    <div className="mb-4 md:mb-6">
      <blockquote className="text-gray-700 italic border-r-4 border-yellow-600 pr-4 md:pr-6 mb-3 md:mb-4 leading-relaxed text-base md:text-lg">
        {quote}
      </blockquote>
    </div>
    ...
    <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
      <a
        ...
        className="inline-flex items-center justify-center px-4 md:px-6 py-2 md:py-3 text-sm md:text-base font-medium text-white rounded-lg transition-colors hover:opacity-90 shadow-sm"
        style={{ backgroundColor: "#76424E" }}
      >
      ...
      <a
        ...
        download
        className="inline-flex items-center justify-center px-4 md:px-6 py-2 md:py-3 text-sm md:text-base font-medium border-2 rounded-lg transition-colors hover:bg-yellow-50"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-12 md:mb-20 px-4">
          <div className="w-16 md:w-20 h-1 mx-auto mb-6 md:mb-8" style={{ backgroundColor: "#BF965A" }}></div>
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-8" style={{ color: "#76424E" }}>
            جدول أعمال الندوة
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 md:p-8 mb-8 md:mb-16">
          <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 md:mb-6 text-center">الانتقال السريع</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2 md:gap-4">
            {[
              ...
              <button
                ...
                className="p-2 md:p-4 text-center rounded-lg md:rounded-xl border border-gray-200 hover:border-yellow-600 hover:bg-yellow-50 transition-all duration-300 group"
              >
                <div className="text-xs md:text-sm font-bold text-gray-900 mb-1 group-hover:text-yellow-700 leading-tight">
                  {item.title}
                </div>
        ...
        <div className="relative">
          ...
          <div
            className="hidden md:block absolute right-44 top-0 bottom-0 w-1 rounded-full"
            style={{ backgroundColor: "#BF965A", opacity: 0.3 }}
          ></div>

          {/* Mobile vertical line */}
          <div
            className="md:hidden absolute right-[88px] top-0 bottom-0 w-0.5 rounded-full"
            style={{ backgroundColor: "#BF965A", opacity: 0.3 }}
          ></div>
